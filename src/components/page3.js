  ...
  render() {
    ...
    return (
      <section className="flex align grad-bg" ref={(section) => {
            ...
            <div className="flex align">
              ...
              <div className="pinkrec middlerec">
                <div className="arrowrightsmall">
                  <img className="arrowsmall" alt="arrow" src={roundArrow} onClick={() => this.increment()} />
                </div>
                <div className={componentText.join(' ')}>
                  <a href={slides[this.state.counter].link} className="link-proj"><h1 className="projtitle">{slides[this.state.counter].title}</h1></a>
                  <div className="projcaption">
                    {slides[this.state.counter].caption1}
                  </div>
                  <VisibilitySensor onChange={this.onChange} />
                </div>
                <img className={componentImg.join(' ')} alt="arrow" src={slides[this.state.counter].imageUrl1}/>
              </div>
        ...
        <img src={roundArrow} alt="arrow" onClick={() => this.increment()} className="arrowright" />
