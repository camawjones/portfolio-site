...
import LittleBitAnimate from './components/LittleBitAnimate';
        ...
        <main>
          ...
          <section className="flex align grad-bg">
            <div  className="cj-logo flex align">
              ...
              <svg className="svg-cj" xmlns="http://www.w3.org/2000/svg" width="400" height="252.21" viewBox="0 0 1896 1071">
                <filter height="180%" id="colorMeSaturate">
                  <feColorMatrix in="SourceGraphic"
                    type="saturate"
                    values="5" />
                </filter>
                <g fill="none" filter="url(#colorMeSaturate)" fillRule="evenodd" strokeWidth="238" transform="translate(119 119)">
                  <path className="path-1" stroke="#EACDD0" d="M0,76 C0,123.148832 4.31329077,169.290242 12.5668074,214.051163 C77.4507841,565.933484 385.845419,832.5 756.5,832.5 L756.5,76" transform="matrix(0 -1 -1 0 832.5 832.5)"/>
                  <path className="path-2" stroke="#EACDD0" d="M901,76 C901,123.148832 905.313291,169.290242 913.566807,214.051163 C978.450784,565.933484 1286.84542,832.5 1657.5,832.5 L1657.5,76" transform="rotate(-90 1279.25 454.25)"/>
                  <path className="path-3" stroke="#FFF" d="M0,0 C0,47.1488324 4.31329077,93.2902417 12.5668074,138.051163 C77.4507841,489.933484 385.845419,756.5 756.5,756.5 L756.5,0" transform="matrix(0 -1 -1 0 756.5 756.5)"/>
                  <path className="path-4" stroke="#FFF" d="M901,0 C901,47.1488324 905.313291,93.2902417 913.566807,138.051163 C978.450784,489.933484 1286.84542,756.5 1657.5,756.5 L1657.5,0" transform="rotate(-90 1279.25 378.25)"/>
                </g>
              </svg>
            </div>
            <svg onClick={() => this.handleClick(this.secondPage)} className="arrow1" xmlns="http://www.w3.org/2000/svg" width="28" height="20" viewBox="0 0 56 40">
          ...
          <section className="secondPage flex align" ref={(section) => { this.secondPage = section; }} >
            ...
            <svg className="arrow2" onClick={() => scrollToComponent(this.page3, { offset: 0, align: 'top', duration: 1500})} xmlns="http://www.w3.org/2000/svg" width="28" height="20" viewBox="0 0 56 40">
              <polyline fill="none" stroke="#FEF9FB" strokeLinecap="round" strokeWidth="5" points="695 975.258 720 943 720 943 745 975.258" transform="matrix(1 0 0 -1 -692 978.258)"/>
            </svg>
          </section>
